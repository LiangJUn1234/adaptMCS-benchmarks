function out = mp_run_acopf_minimal(case_data, debug, ac_fail_as_violation)
%MP_RUN_ACOPF_MINIMAL Minimal AC OPF wrapper with scalar score outputs.
%   out = MP_RUN_ACOPF_MINIMAL(case_data, debug, ac_fail_as_violation)
%   accepts either a MATPOWER case name (e.g., 'case14') or case struct,
%   runs AC OPF once, and returns scalar security scores.
%
...
%   - Add optional timing metadata for profiling.
