function out = mp_run_dcopf_minimal(case_data, debug, ac_fail_as_violation)
%MP_RUN_DCOPF_MINIMAL Minimal DC OPF wrapper with scalar score outputs.
%   out = MP_RUN_DCOPF_MINIMAL(case_data, debug, ac_fail_as_violation)
%   accepts either a MATPOWER case name (e.g., 'case14') or case struct,
%   runs DC OPF once, and returns scalar security scores.
%
