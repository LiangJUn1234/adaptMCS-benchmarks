function out = mp_run_acpf_minimal(case_data, debug, ac_fail_as_violation)
%MP_RUN_ACPF_MINIMAL Minimal AC PF wrapper with scalar score outputs.
%   out = MP_RUN_ACPF_MINIMAL(case_data, debug, ac_fail_as_violation)
%   accepts either a MATPOWER case name (e.g., 'case14') or case struct,
%   runs AC PF once, and returns scalar security scores.
%
